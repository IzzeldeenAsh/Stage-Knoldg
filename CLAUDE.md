...
- Environment-specific API endpoints (dev: localhost, prod: api.knoldg.co)
...
Development uses mock services (`isMockEnabled: true`) with local API endpoints. Production connects to `https://api.knoldg.co/api`.
