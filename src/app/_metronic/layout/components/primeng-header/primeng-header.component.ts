...
export class PrimengHeaderComponent implements OnInit, OnDestroy {
  ...
  handleSearch(query: string = this.searchQuery, searchType: 'knowledge' | 'insighter' = 'knowledge') {
    ...
    const searchUrl = `https://foresight.co/${this.lang}/home?${searchParams.toString()}`;
  ...
  getHomeUrl(): string {
    const url= 'https://foresight.co/' + this.lang;
    return url;
  }
  ...
  fetchIndustries() {
    ...
    this.http.post<IndustriesResponse>('https://api.foresight.co/api/platform/industries/menu', body, { headers })
      .subscribe({
        next: (response) => {
  ...
  getIndustryUrl(industry: Industry): string {
    return `https://foresight.co/en/industry/${industry.id}/${industry.slug}`;
  }
  ...
  initializeMenu() {
    ...
    const menuItems = [
      industriesMenuItem, // Add Industries as first item
      {
        ...
        iconType: 'outline',
        expanded: false,
        routerLink: 'https://foresight.co/en/industries/report'
      },
      {
        ...
        iconType: 'outline',
        expanded: false,
        routerLink: 'https://foresight.co/en/industries/insight'
      },
     
      {
        ...
        iconType: 'outline',
        expanded: false,
        routerLink: 'https://foresight.co/en/industries/data'
      },
      {
        ...
        iconType: 'outline',
        expanded: false,
        routerLink: 'https://foresight.co/en/industries/manual'
      },
      {
        ...
        iconType: 'outline',
        expanded: false,
        routerLink: 'https://foresight.co/en/industries/course'
      }
    ];
  ...
  toggleNotifications(event: Event) {
    ...
    if (this.isNotificationsOpen && this.notificationCount > 0) {
      ...
      // this.http.put('https://api.foresight.co/api/account/notification/read', {}, { headers })
      //   .subscribe({
      //     next: () => {
