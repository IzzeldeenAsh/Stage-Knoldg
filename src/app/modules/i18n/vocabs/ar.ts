export const locale = {
  ...
  `,
    ...
    ENTER_KNOWLEDGE_DESCRIPTION: "ادخل الوصف",
    ...
    PUBLISH_OPTIONS_TOOLTIP: 'اختر الطريقة التي تريد بها نشر المحتوى الخاص بك.',
    SELECT_PUBLISH_METHOD: 'اختر طريقة النشر المفضلة لديك.',
    PUBLISH_OPTION_REQUIRED: 'يرجى اختيار خيار نشر.',
    SCHEDULE_PUBLISHING: 'جدولة النشر',
    SELECT_DATE: 'اختر التاريخ',
    VALID_DATE_REQUIRED: 'يرجى إدخال تاريخ صالح.',
    SELECT_TIME: 'اختر الوقت',
    VALID_TIME_REQUIRED: 'يرجى إدخال وقت صالح.',
  
    // خيارات النشر
    PUBLISH_NOW: 'نشر الآن',
    PUBLISH_NOW_DESC: 'اجعل محتواك متاحًا فورًا.',
    SCHEDULE: 'جدولة',
    SCHEDULE_DESC: 'حدد تاريخًا ووقتًا محددًا لنشر محتواك.',
    DRAFT: 'حفظ كمسودة',
    SAVE_AS_DRAFT: 'حفظ كمسودة',
    SAVE_AS_DRAFT_DESC: 'احفظ محتواك بدون نشره.',
    VIEW_LIBRARY: 'عرض المكتبة',
    CHOOSE_REGIONS: 'اختر المناطق',
    SELECT_ALL_COUNTRIES: 'اختر جميع الدول',
    CONFIRM: 'تأكيد',
    CANCEL: 'إلغاء',
    CHOOSE_ECONOMIC_BLOCKS: 'اختر المناطق الاقتصادية',
    COUNTRIES_IN_SELECTED_BLOCKS: 'الدول في المناطق المختارة',
    CHAPTER: 'الفصل',
    NAME: 'اسم',
    CHAPTER_NAME_REQUIRED: 'اسم الفصل مطلوب.',
    PAGE_INDEX: 'رقم الصفحة',
    INDEX: 'الفهرس',
    ...
    DROP_FILE_HERE: 'إسقاط ملف هنا أو اضغط للرفع',
    UPLOAD_ONE_FILE: 'رفع ملف واحد',
    UPLOAD_FILE_HERE: 'رفع ملف هنا أو اضغط للرفع',
    SELECT_TAGS: "اختر العلامات",
    SELECT_ALL: "اختر الكل",
    CLEAR_ALL: "مسح الكل",
    ADD_CUSTOM_TAG: "إضافة علامة مخصصة",
    TAG_NAME: "اسم العلامة",
    TAG_NAME_REQUIRED: "اسم العلامة مطلوب",
    ADD_TAG: "إضافة علامة",
    KEYWORDS: "الكلمات المفتاحية",
    ENTER_KEYWORDS: "أدخل الكلمات المفتاحية",
    KNOWLEDGE_SAVED_AS_DRAFT: "تم حفظ المعرفة كمسودة بنجاح",
    KNOWLEDGE_PUBLISHED: "تم نشر المعرفة بنجاح وهي متاحة الآن للجميع",
    KNOWLEDGE_SCHEDULED: "تم جدولة نشر المعرفة بنجاح في الموعد المحدد",
    KNOWLEDGE_DRAFT_MESSAGE: "تم حفظ معرفتك كمسودة بنجاح. يمكنك الوصول إليها وتعديلها ونشرها في أي وقت من خلال لوحة التحكم الخاصة بك. المسودات المحفوظة تظل خاصة حتى تقرر نشرها.",
    KNOWLEDGE_PUBLISHED_MESSAGE: "تهانينا! تم نشر معرفتك بنجاح وهي الآن متاحة للجميع للاطلاع عليها والاستفادة منها. يمكنك متابعة أداء المحتوى وتفاعل المستخدمين معه من خلال لوحة التحكم.",
