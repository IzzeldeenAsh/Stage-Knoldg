export const locale = {
  ...
  DELETE_FILE: "حذف الملف", // Tooltip for delete file button
    ...
    "DEACTIVATE_ACCOUNT": {
      ...
      "DESCRIPTION": "إلغاء تنشيط حسابك بشكل دائم. لا يمكن التراجع عن هذا الإجراء وسيؤدي إلى إزالة جميع بياناتك من نظامنا.",
      "BUTTON_TEXT": "إلغاء تنشيط الحساب",
      "ILLUSTRATION_ALT": "صورة إلغاء تنشيط الحساب",
      "MODAL": {
        "TITLE": "إلغاء تنشيط حساب الشركة",
        "DESCRIPTION": "أنت على وشك إلغاء تنشيط حساب شركتك. سيؤدي هذا إلى إزالة جميع بيانات شركتك من منصتنا.",
