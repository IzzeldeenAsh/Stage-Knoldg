...
<br><br>Build your ideal team from a pool of expert consultants and execute a tailored project plan to achieve your objectives.
  ...
  REPORTS: "Reports",
  MANUAL: "Manual",
  DATA_DESCRIPTION: "Raw data sets, statistics, and numerical information for analysis",
  INSIGHTS_DESCRIPTION: "Curated insights offering business intelligence and market trends",
  REPORTS_DESCRIPTION: "In-depth reports featuring analysis and expert recommendations",
  MANUAL_DESCRIPTION:"Practical guides, procedures, and instructional resources",
  ...
  DATA_DOCUMENTS: "Upload Data Nodes",
  MEDIA_DOCUMENTS: "Upload Media Nodes",
  COURSE_DOCUMENTS: "Upload Course Nodes",
  REPORT_DOCUMENTS: "Upload Report",
  REPORTS_CHAPTERS_DETAILS: "Upload by chapter (priced separately) or as one full report",
  MANUAL_DOCUMENTS: "Upload Manual Nodes",
  INSIGHT_DOCUMENTS: "Upload Insight Nodes",
  ADD_DOCUMENT: "Add Document",
  ADD_NODE: "Add Node",
  UPLOAD_BY_CHAPTRE_OR_ALL:"Upload by chapter or (priced separately) or as a one full document",
...
'TITLE': 'My knowledge library',
  ...
  OVERVIEW: "Dashboard",
    "COURSE": "Course",
    "COURSE_DESCRIPTION":"Courses with lessons and clear learning objectives",
    "MEDIA": "Media",
