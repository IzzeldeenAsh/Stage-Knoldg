...
export const locale = {
  ...
  "ADD_CUSTOM_TAG_INSTRUCTION": "You can add custom tags using the 'Add Custom Tag' button.",
    ...
    ENTER_KNOWLEDGE_DESCRIPTION: 'Enter a detailed description of your knowledge',
...
<br><br>Build your ideal team from a pool of expert consultants and execute a tailored project plan to achieve your objectives.
  ...
  KNOWLEDGE_DESCRIPTION: "Enter Knowledge Description",
  ...
  INSIGHT_LANGUAGE: "Language used in the insight documents",
  ...
  REPORT_DOCUMENTS: "Upload Report Nodes",
  ...
  PUBLISH_NOW_DESC: 'Make your content live immediately.',  
  SCHEDULE: 'Schedule',
  SCHEDULE_DESC: 'Set a specific date and time to publish your content.',
  DRAFT: 'Save as Draft',
