...
export const locale = {
  ...
  data: {
    ...
    START_UPLOADING:'Start Publishing Knowledge!',
    LATEST_KNOWLEDGE:'Latest Knowledge',
    START_UPLOADING_DESRIPTION:'Share your knowledge with the world! <br> Publish a knowledge now!',
    SHOW_LESS:'Show Less',
    SHOW_MORE:'Show More',
  ...
  "ADD_CUSTOM_TAG_INSTRUCTION": "You can add custom tags using the 'Add Custom Tag' button.",
    ...
    BUILD_YOUR_TEAM: 'Build up your team!',
    BUILD_YOUR_TEAM_DESCRIPTION: 'Grow your business by  adding  employees <br> to your company',
