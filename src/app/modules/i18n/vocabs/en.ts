...
export const locale = {
  ...
  data: {
    ...
    STATISTIC: 'Statistic',
    START_UPLOADING_DESRIPTION:'Share your knowledge with the world!',
    SHOW_LESS:'Show Less',
    SHOW_MORE:'Show More',
   ...
   ACCOUNT: 'Account',
    ...
    REVIEW_KNOWLEDGE: 'Review Knowledge',
    'WORLDWIDE': 'Worldwide',
  ...
  "ADD_CUSTOM_TAG_INSTRUCTION": "You can add custom tags using the 'Add Custom Tag' button.",
    ...
    "MY_KNOWLEDGE": {
      ...
      "NO_POSTED": {
        ...
        "MESSAGE": "You don't have any published knowledge items at the moment.",
...
<br><br>Build your ideal team from a pool of expert consultants and execute a tailored project plan to achieve your objectives.
  ...
  "TOTAL_DOCUMENTS": "Total Documents",
      DOWNLOAD_COUNT_TOOLTIP: "The number of times this knowledge has been downloaded",
      DOWNLOAD_COUNT_TOOLTIP_EXPLANATION: "The number of times this knowledge has been downloaded",
      VIEW: "View",
    ...
    INSIGHTER_WIZARD: {
      ...
      KNOWLEDGE_TYPE_TOOLTIP_EXPLANATION: "Choose the type of knowledge libraryd on the type of files you want to upload. You can choose from different types such as data (data), reports, insights, evidence (manuscript), and others. Select the type that best matches the content of your knowledge.",
      COMPANY_PHONE: "Company Phone",
  ...
  KNOWLEDGE_LANGUAGE: "Language used in the knowledge documents",
  ...
  KNOWLEDGE_LANGUAGE_TOOLTIP: "Enter language used in this knowledge documents",
  ...
  KNOWLEDGE_TYPE_TOOLTIP_EXPLANATION: "Choose the type of knowledge libraryd on the type of files you want to upload. You can choose from different types such as data, reports, insights, manuals, and others. Select the type that best matches the content of your knowledge.",
  COPY_LINK:'Copy link',
...
UPLOAD: 'Upload',
  ...
  ADD_TAG: "Add Tag",
  "KEEP_GROWING": "Keep Growing Your knowledge library",
  "ADD_MORE_KNOWLEDGE_MESSAGE": "Continue expanding your knowledge library with more insights and expertise. The more knowledge you add, the more valuable your collection becomes.",
  "ADD_NEW_KNOWLEDGE": "Add New Knowledge",
  KEYWORDS: "Keywords",
  ENTER_KEYWORDS: "Select or Add custom Keyword",
  UPLOAD_YOUR_DOCUMENT: 'Upload your document',
  KNOWLEDGE_SAVED_AS_DRAFT: "Knowledge saved as draft",
  REGIONS_REQUIRED:'Regions Required',
  KNOWLEDGE_PUBLISHED: "Knowledge published successfully",
  KNOWLEDGE_SCHEDULED: "Knowledge scheduled for publication",
  KNOWLEDGE_DRAFT_MESSAGE: "Your knowledge has been saved as a draft. You can edit and publish it anytime from your dashboard.",
...
'TITLE': 'My insights library',
    ...
    'STATUS': 'Status',
    "UPLOAD_ILLUSTRATION_ALT": "Upload knowledge illustration",
    "NO_ITEMS_YET": "You don't have any knowledge items yet",
    "START_CREATING": "Start by creating your first knowledge item. You can add data, insights, reports, manuals, courses, or media.",
    'EDIT': 'Edit',
    'VIEW': 'View',
    'DELETE': 'Delete',
    'PUBLISH': 'Publish',
  ...
  OVERVIEW: "Dashboard",
    ...
    "EMPLOYEE_KNOWLEDGE": {
      "TITLE": "Employee Knowledge Contributions",
      "SUBTITLE": "Overview of knowledge content published by each employee",
      "EMPLOYEES": "Employees",
      "ITEMS": "items",
      "LOAD_ERROR": "Failed to load employee knowledge statistics",
      "RETRY": "Retry",
      "REFRESH": "Refresh",
    ...
    "COMPANY_SALES_STATISTICS": {
      ...
      "SUBTITLE": "Total knowledge orders per insighter",
