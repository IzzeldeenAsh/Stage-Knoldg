...
export class AuthService implements OnDestroy {
  ...
  login(email: string, password: string, lang: string, returnUrl?: string): Observable<{userData: any, token: string}> {
    ...
    return this.authHttpService.login(email, password, lang).pipe(
      switchMap((response: any) => {
        ...
        return this.http.get('https://api.knoldg.co/api/account/profile', { headers }).pipe(
  ...
  logout(): Observable<any> {
    ...
    return this.http.post<any>(
      'https://api.knoldg.co/api/account/logout',
      {},
      { headers }
    ).pipe(
  ...
  resendVerificationEmail(): Observable<any> {
    ...
    return this.http.post('https://api.knoldg.co/api/account/email/resend', {}, { headers }).pipe(
      catchError((error) => this.handleError(error))
    );
  }
  ...
  getGoogleAuthRedirectUrl(): Observable<string> {
    ...
    return this.http.get('https://api.knoldg.co/api/auth/provider/google', { 
      headers,
      responseType: 'text'
    });
  }
  ...
  getLinkedInAuthRedirectUrl(): Observable<string> {
    ...
    return this.http.get('https://api.knoldg.co/api/auth/provider/linkedin-openid', {
      headers,
      responseType: 'text'
    });
  }
