...
export class MyOrdersService {
  private readonly API_URL = 'https://api.foresigha.co/api/account/order/knowledge';
  private readonly MEETING_API_URL = 'https://api.foresigha.co/api/account/order/meeting';
  private readonly COMPANY_KNOWLEDGE_API_URL = 'https://api.foresigha.co/api/company/order/knowledge';
  private readonly INSIGHTER_KNOWLEDGE_API_URL = 'https://api.foresigha.co/api/insighter/order/knowledge';
  private readonly COMPANY_MEETING_API_URL = 'https://api.foresigha.co/api/company/order/meeting';
  private readonly INSIGHTER_MEETING_API_URL = 'https://api.foresigha.co/api/insighter/order/meeting';
  private readonly INSIGHTER_STATISTICS_API_URL = 'https://api.foresigha.co/api/insighter/order/statistics';
