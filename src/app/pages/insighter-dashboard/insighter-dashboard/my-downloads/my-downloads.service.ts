...
export class MyDownloadsService {
  private readonly API_URL = 'https://api.foresight.co/api/account/library/my-knowledge';
  private readonly STATISTICS_URL = 'https://api.foresight.co/api/account/library/my-knowledge/statistics';
  private readonly DOWNLOAD_KNOWLEDGE_URL = 'https://api.foresight.co/api/account/library/my-knowledge/download';
  private readonly DOWNLOAD_DOCUMENT_URL = 'https://api.foresight.co/api/account/library/my-knowledge/document/download';
