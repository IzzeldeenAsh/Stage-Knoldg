...
export class MyDownloadsService {
  private readonly API_URL = 'https://api.knoldg.comm/api/account/library/my-knowledge';
  private readonly DOWNLOAD_KNOWLEDGE_URL = 'https://api.knoldg.comm/api/account/library/my-knowledge/download';
  private readonly DOWNLOAD_DOCUMENT_URL = 'https://api.knoldg.comm/api/account/library/my-knowledge/document/download';
