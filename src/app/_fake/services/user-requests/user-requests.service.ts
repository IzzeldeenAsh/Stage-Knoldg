...
export class UserRequestsService {
  private apiUrl = 'https://api.foresight.co/api/account/request';
  private insighterRequestsUrl = 'https://api.foresight.co/api/company/insighter/request';
  ...
  sendActivationRequest(comments: string, parentId: string): Observable<any> {
    const url = 'https://api.foresight.co/api/company/request/activate';
  ...
  sendVerificationRequest(comments: string, parentId: string): Observable<any> {
    const url = 'https://api.foresight.co/api/company/request/verified';
    const formData = new FormData();
    formData.append('comments', comments);
    formData.append('parent_id', parentId);
  ...
  sendDeactivateAndDeleteRequest(comments: string, parentId: string): Observable<any> {
    const url = 'https://api.foresight.co/api/company/request/deactivate-delete';
    const formData = new FormData();
    formData.append('comments', comments);
    formData.append('parent_id', parentId);
  ...
  sendDeactivateAndDeleteRequestInsighter(comments: string, parentId: string): Observable<any> {
    const url = 'https://api.foresight.co/api/insighter/request/deactivate-delete';
    const formData = new FormData();
    formData.append('comments', comments);
    formData.append('parent_id', parentId);
  ...
  sendReactivateRequest(type:string): Observable<any> {
    const url = type === 'company' ? 'https://api.foresight.co/api/company/activate' : 'https://api.foresight.co/api/insighter/activate';
  ...
  sendKnowledgeReviewRequest(comments: string, parentId: string, knowledgeId: string): Observable<any> {
    const url = 'https://api.foresight.co/api/insighter/request/knowledge/review';
