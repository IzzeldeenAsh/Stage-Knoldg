...
export class UserRequestsService {
  private apiUrl = 'https://api.knoldg.comm/api/account/request';
  private insighterRequestsUrl = 'https://api.knoldg.comm/api/company/insighter/request';
  ...
  sendActivationRequest(comments: string, parentId: string): Observable<any> {
    const url = 'https://api.knoldg.comm/api/company/request/activate';
  ...
  sendVerificationRequest(comments: string, parentId: string): Observable<any> {
    const url = 'https://api.knoldg.comm/api/company/request/verified';
    const formData = new FormData();
    formData.append('comments', comments);
    formData.append('parent_id', parentId);
  ...
  sendDeactivateAndDeleteRequest(comments: string, parentId: string): Observable<any> {
    const url = 'https://api.knoldg.comm/api/company/request/deactivate-delete';
    const formData = new FormData();
    formData.append('comments', comments);
    formData.append('parent_id', parentId);
  ...
  sendDeactivateAndDeleteRequestInsighter(comments: string, parentId: string): Observable<any> {
    const url = 'https://api.knoldg.comm/api/insighter/request/deactivate-delete';
    const formData = new FormData();
    formData.append('comments', comments);
    formData.append('parent_id', parentId);
  ...
  sendReactivateRequest(type:string): Observable<any> {
    const url = type === 'company' ? 'https://api.knoldg.comm/api/company/activate' : 'https://api.knoldg.comm/api/insighter/activate';
  ...
  sendKnowledgeReviewRequest(comments: string, parentId: string, knowledgeId: string): Observable<any> {
    const url = 'https://api.knoldg.comm/api/insighter/request/knowledge/review';
