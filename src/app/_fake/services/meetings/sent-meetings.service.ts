...
export class SentMeetingsService {
  private apiUrl = 'https://api.foresight.co/api/account/meeting/client/list';
  ...
  getAvailableHours(insighterUuid: string): Observable<AvailableHoursResponse> {
    const headers = this.getHeaders();
    const url = `https://api.foresight.co/api/account/meeting/available/hours/${insighterUuid}`;
  ...
  rescheduleMeeting(meetingUuid: string, rescheduleData: RescheduleRequest): Observable<any> {
    ...
    const url = `https://api.foresight.co/api/account/meeting/reschedule/${meetingUuid}`;
  ...
  archiveMeeting(meetingUuid: string): Observable<any> {
    const headers = this.getHeaders();
    const url = `https://api.foresight.co/api/account/meeting/archive/${meetingUuid}`;
  ...
  getArchivedMeetings(page: number = 1, perPage: number = 10): Observable<SentMeetingResponse> {
    const headers = this.getHeaders();
    const url = 'https://api.foresight.co/api/account/meeting/client/list';
  ...
  getMeetingStatistics(): Observable<{ data: MeetingStatistics }> {
    const headers = this.getHeaders();
    const url = 'https://api.foresight.co/api/account/meeting/statistics';
