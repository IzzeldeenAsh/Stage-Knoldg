...
export class RequestsService {
  private apiUrl = 'https://api.foresight.co/api/admin/request'; // POST endpoint for requests
  private verificationQuestionsUrl = 'https://api.foresight.co/api/common/setting/verification-question/list';
  ...
  getRequestVerificationQuestion(requestId: number): Observable<any> {
    const url = `https://api.foresight.co/api/admin/request/verification/question/${requestId}`;
  ...
  sendVerificationAnswers(requestId: number, verificationAnswers: VerificationAnswer[]): Observable<any> {
    const url = `https://api.foresight.co/api/admin/request/action/company/verified/question/${requestId}`;
    const body = { 
  ...
  deactivateDeleteRequest(requestId: number, staffNotes: string, status: 'approved' | 'declined'): Observable<any> {
    ...
    const url = `https://api.foresight.co/api/admin/request/action/company/deactivate-delete/${requestId}`;
    const body = {
      staff_notes: staffNotes,
      status: status
    };
