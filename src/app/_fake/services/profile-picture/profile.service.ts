...
export class ProfileService {
  private uploadUrl = 'https://api.knoldg.comm/api/account/profile/photo';
  private removeUrl = 'https://api.knoldg.comm/api/account/profile/photo/remove';
  private updateLogo = 'https://api.knoldg.comm/api/account/profile/company/logo';
