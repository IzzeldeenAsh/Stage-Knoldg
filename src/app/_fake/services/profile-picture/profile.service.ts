...
export class ProfileService {
  private uploadUrl = 'https://api.foresigha.co/api/account/profile/photo';
  private removeUrl = 'https://api.foresigha.co/api/account/profile/photo/remove';
  private updateLogo = 'https://api.foresigha.co/api/account/profile/company/logo';
