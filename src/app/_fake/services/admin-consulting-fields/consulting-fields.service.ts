...
export class ConsultingFieldsService {
  private apiUrl = 'https://api.knoldg.com/api/common/setting/consulting-field/list';
  private createApi = 'https://api.knoldg.com/api/admin/setting/consulting-field';
  private updateDeleteApi = 'https://api.knoldg.com/api/admin/setting/consulting-field';
