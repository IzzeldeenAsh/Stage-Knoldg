...
export class ConsultingFieldsService {
  private apiUrl = 'https://api.knoldg.comm/api/common/setting/consulting-field/list';
  private createApi = 'https://api.knoldg.comm/api/admin/setting/consulting-field';
  private updateDeleteApi = 'https://api.knoldg.comm/api/admin/setting/consulting-field';
