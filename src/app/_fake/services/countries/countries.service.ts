...
export class CountriesService {
  private apiUrl = 'https://api.foresight.co/api/common/setting/country/list';
  private createApi = 'https://api.foresight.co/api/admin/setting/country';
  private updateDeleteApi = 'https://api.foresight.co/api/admin/setting/country';
