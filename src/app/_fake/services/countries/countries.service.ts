...
export class CountriesService {
  private apiUrl = 'https://api.knoldg.comm/api/common/setting/country/list';
  private createApi = 'https://api.knoldg.comm/api/admin/setting/country';
  private updateDeleteApi = 'https://api.knoldg.comm/api/admin/setting/country';
