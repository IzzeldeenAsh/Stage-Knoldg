...
export class CountriesService {
  private apiUrl = 'https://api.knoldg.co/api/common/setting/country/list';
  private createApi = 'https://api.knoldg.co/api/admin/setting/country';
  private updateDeleteApi = 'https://api.knoldg.co/api/admin/setting/country';
