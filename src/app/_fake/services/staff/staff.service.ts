...
export class StaffService {
  private apiUrl = 'https://api.foresigha.co/api/admin/account/staff/list';
  private createApi = 'https://api.foresigha.co/api/admin/account/staff';
  private updateDeleteApi = 'https://api.foresigha.co/api/admin/account/staff';
