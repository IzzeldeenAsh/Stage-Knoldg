...
export class StaffService {
  private apiUrl = 'https://api.knoldg.com/api/admin/account/staff/list';
  private createApi = 'https://api.knoldg.com/api/admin/account/staff';
  private updateDeleteApi = 'https://api.knoldg.com/api/admin/account/staff';
