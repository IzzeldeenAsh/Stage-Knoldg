...
export class StaffService {
  private apiUrl = 'https://api.knoldg.co/api/admin/account/staff/list';
  private createApi = 'https://api.knoldg.co/api/admin/account/staff';
  private updateDeleteApi = 'https://api.knoldg.co/api/admin/account/staff';
