...
export class StaffService {
  private apiUrl = 'https://api.foresight.co/api/admin/account/staff/list';
  private createApi = 'https://api.foresight.co/api/admin/account/staff';
  private updateDeleteApi = 'https://api.foresight.co/api/admin/account/staff';
