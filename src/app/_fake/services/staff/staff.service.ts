...
export class StaffService {
  private apiUrl = 'https://api.knoldg.comm/api/admin/account/staff/list';
  private createApi = 'https://api.knoldg.comm/api/admin/account/staff';
  private updateDeleteApi = 'https://api.knoldg.comm/api/admin/account/staff';
