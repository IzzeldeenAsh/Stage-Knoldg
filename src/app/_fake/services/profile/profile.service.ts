...
export class UpdateProfileService {
  private postProfileUrl = 'https://api.foresight.co/api/account/profile';
  private insighterSocialUrl = 'https://api.foresight.co/api/insighter/social';
  private companySocialUrl = 'https://api.foresight.co/api/company/social';
  private deleteCertificateUrl = 'https://api.foresight.co/api/account/profile/certification';
  private updateCompanyInfoUrl = 'https://api.foresight.co/api/account/profile/company/info';
  private deleteCompanyCertificateUrl = 'https://api.foresight.co/api/account/profile/company/certification';
  ...
  uploadCertificate(certificationType: string, file: File): Observable<any> {
    ...
    this.setLoading(true);
    return this.http.post<any>('https://api.foresight.co/api/account/profile/certification', formData, { headers }).pipe(
      map((res) => res),
      catchError((error) => this.handleError(error)),
      finalize(() => this.setLoading(false))
    );
  ...
  updateCompanyCertification(certificationType: string, file: File): Observable<any> {
    ...
    this.setLoading(true);
    return this.http.post<any>('https://api.foresight.co/api/account/profile/company/certification', formData, { headers }).pipe(
      map((res) => res),
      catchError((error) => this.handleError(error)),
      finalize(() => this.setLoading(false))
    );
