...
export class PositionsService {
  private apiUrl = 'https://api.knoldg.co/api/admin/setting/position';
  private createApi = 'https://api.knoldg.co/api/admin/setting/position';
  private updateDeleteApi = 'https://api.knoldg.co/api/admin/setting/position';
