...
export class PositionsService {
  private apiUrl = 'https://api.foresight.co/api/admin/setting/position';
  private createApi = 'https://api.foresight.co/api/admin/setting/position';
  private updateDeleteApi = 'https://api.foresight.co/api/admin/setting/position';
