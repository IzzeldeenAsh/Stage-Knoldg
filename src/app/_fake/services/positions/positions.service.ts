...
export class PositionsService {
  private apiUrl = 'https://api.knoldg.com/api/admin/setting/position';
  private createApi = 'https://api.knoldg.com/api/admin/setting/position';
  private updateDeleteApi = 'https://api.knoldg.com/api/admin/setting/position';
