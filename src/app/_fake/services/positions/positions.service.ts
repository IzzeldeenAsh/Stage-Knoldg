...
export class PositionsService {
  private apiUrl = 'https://api.knoldg.comm/api/admin/setting/position';
  private createApi = 'https://api.knoldg.comm/api/admin/setting/position';
  private updateDeleteApi = 'https://api.knoldg.comm/api/admin/setting/position';
