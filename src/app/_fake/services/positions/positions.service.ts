...
export class PositionsService {
  private apiUrl = 'https://api.foresigha.co/api/admin/setting/position';
  private createApi = 'https://api.foresigha.co/api/admin/setting/position';
  private updateDeleteApi = 'https://api.foresigha.co/api/admin/setting/position';
