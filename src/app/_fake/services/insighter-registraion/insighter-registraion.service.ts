...
export class InsighterRegistraionService {
  private individuial_insighter = 'https://api.foresigha.co/api/account/insighter/individual/register'
  private company_insighter = 'https://api.foresigha.co/api/account/insighter/company/register'
