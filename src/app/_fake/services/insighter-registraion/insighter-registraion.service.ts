...
export class InsighterRegistraionService {
  private individuial_insighter = 'https://api.knoldg.comm/api/account/insighter/individual/register'
  private company_insighter = 'https://api.knoldg.comm/api/account/insighter/company/register'
