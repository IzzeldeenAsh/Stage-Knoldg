...
export class RolesService {
  ...
  private userRoleUrl = 'https://api.knoldg.comm/api/admin/account/role/user';
  private rolePermissionsApi = 'https://api.knoldg.comm/api/admin/account/permission/role';
  private syncRolePermissionsApi = 'https://api.knoldg.comm/api/admin/account/permission/role/sync';
  ...
  syncRolesForUser(userId: number, roles: number[]): Observable<any> {
    ...
    this.setLoading(true);
    const url = `https://api.knoldg.comm/api/admin/account/role/user/sync/${userId}`;
