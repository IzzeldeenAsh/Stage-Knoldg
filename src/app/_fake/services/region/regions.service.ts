...
export class RegionsService {
  private apiUrl = 'https://api.knoldg.comm/api/admin/setting/region';
  private createApi = 'https://api.knoldg.comm/api/admin/setting/region';
  private updateDeleteApi = 'https://api.knoldg.comm/api/admin/setting/region';
  private getListApi = 'https://api.knoldg.comm/api/common/setting/region/list';
