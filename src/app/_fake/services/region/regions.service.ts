...
export class RegionsService {
  private apiUrl = 'https://api.knoldg.co/api/admin/setting/region';
  private createApi = 'https://api.knoldg.co/api/admin/setting/region';
  private updateDeleteApi = 'https://api.knoldg.co/api/admin/setting/region';
  private getListApi = 'https://api.knoldg.co/api/common/setting/region/list';
