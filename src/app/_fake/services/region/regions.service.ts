...
export class RegionsService {
  private apiUrl = 'https://api.4sighta.com/api/admin/setting/region/list';
  private createApi = 'https://api.4sighta.com/api/admin/setting/region';
  private updateDeleteApi = 'https://api.4sighta.com/api/admin/setting/region';
