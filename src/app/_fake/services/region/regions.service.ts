...
export class RegionsService {
  private apiUrl = 'https://api.knoldg.com/api/admin/setting/region';
  private createApi = 'https://api.knoldg.com/api/admin/setting/region';
  private updateDeleteApi = 'https://api.knoldg.com/api/admin/setting/region';
  private getListApi = 'https://api.knoldg.com/api/common/setting/region/list';
