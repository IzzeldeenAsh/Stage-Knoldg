...
export class IndustryService {
  private apiUrl = 'https://api.knoldg.comm/api/common/setting/industry/tree-list'; 
  private apiList = 'https://api.knoldg.comm/api/common/setting/industry/list'
  ...
  getIsicCodesTree(lang:string): Observable<any[]> {
    ...
    getIsicCodesTreeParent(): Observable<any[]> {
      ...
      this.setLoading(true);
      return this.http.get<any>('https://api.knoldg.comm/api/common/setting/industry/tree/parent', { headers }).pipe(
  ...
  createIsicCode(isicCode: any,lang:string): Observable<IsicCode> {
    ...
    this.setLoading(true);
    return this.http.post<IsicCode>('https://api.knoldg.comm/api/admin/setting/industry', isicCode, { headers }).pipe(
  ...
  updateIsicCode(id: number, isicCode: any): Observable<IsicCode> {
    ...
    this.setLoading(true);
    return this.http.put<IsicCode>(`https://api.knoldg.comm/api/admin/setting/industry/${id}`, isicCode, { headers }).pipe(
      catchError(this.handleError),
      finalize(() => this.setLoading(false))
    );
  }
  ...
  deleteIsicCode(id: number): Observable<any> {
    ...
    this.setLoading(true);
    return this.http.delete<any>(`https://api.knoldg.comm/api/admin/setting/industry/${id}`, { headers }).pipe(
      catchError(this.handleError),
      finalize(() => this.setLoading(false))
    );
  }
