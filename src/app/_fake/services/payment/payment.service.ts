...
export class PaymentService {
  private stripeCountriesApiUrl = 'https://api.foresight.co/api/insighter/payment/account/stripe/countries';
  private setPrimaryApiUrl = 'https://api.foresight.co/api/insighter/payment/account/primary/set';
  private generateOtpApiUrl = 'https://api.foresight.co/api/insighter/payment/account/otp/generate';
  private accountDetailsApiUrl = 'https://api.foresight.co/api/insighter/payment/account/details';
  private setManualAccountApiUrl = 'https://api.foresight.co/api/insighter/payment/account/manual/set';
  private updateManualAccountApiUrl = 'https://api.foresight.co/api/insighter/payment/account/manual/update';
  private deleteManualAccountApiUrl = 'https://api.foresight.co/api/insighter/payment/account/manual/delete';
  private stripeCreateApiUrl = 'https://api.foresight.co/api/insighter/payment/account/stripe/create';
  private stripeLinkApiUrl = 'https://api.foresight.co/api/insighter/payment/account/stripe/link';
  private stripeCompleteApiUrl = 'https://api.foresight.co/api/insighter/payment/account/stripe/complete';
  private deleteStripeApiUrl = 'https://api.foresight.co/api/insighter/payment/account/stripe/delete';
  private manualTermsApiUrl = 'https://api.foresight.co/api/common/setting/guideline/slug/wallet-payment-terms-and-conditions';
  private stripeTermsApiUrl = 'https://api.foresight.co/api/common/setting/guideline/slug/stripe-payment-terms-and-conditions';
