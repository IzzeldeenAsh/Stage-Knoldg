...
export class EconomicBlockService {
  private apiUrl = 'https://api.knoldg.com/api/common/setting/economic-bloc/list';
  private adminApiUrl = 'https://api.knoldg.com/api/admin/setting/economic-bloc';
  private createApi = 'https://api.knoldg.com/api/admin/setting/economic-bloc';
  private updateDeleteApi = 'https://api.knoldg.com/api/admin/setting/economic-bloc';
