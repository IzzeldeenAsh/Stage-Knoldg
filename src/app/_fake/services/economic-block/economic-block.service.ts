...
export class EconomicBlockService {
  private apiUrl = 'https://api.foresight.co/api/common/setting/economic-bloc/list';
  private adminApiUrl = 'https://api.foresight.co/api/admin/setting/economic-bloc';
  private createApi = 'https://api.foresight.co/api/admin/setting/economic-bloc';
  private updateDeleteApi = 'https://api.foresight.co/api/admin/setting/economic-bloc';
