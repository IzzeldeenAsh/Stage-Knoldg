...
export class EconomicBlockService {
  private apiUrl = 'https://api.knoldg.comm/api/common/setting/economic-bloc/list';
  private adminApiUrl = 'https://api.knoldg.comm/api/admin/setting/economic-bloc';
  private createApi = 'https://api.knoldg.comm/api/admin/setting/economic-bloc';
  private updateDeleteApi = 'https://api.knoldg.comm/api/admin/setting/economic-bloc';
