...
export class DepartmentsService {
  private apiUrl = 'https://api.knoldg.comm/api/common/setting/department/list'; // Replace with the actual API URL
  private createApi = "https://api.knoldg.comm/api/admin/setting/department"; // Replace with the actual API URL
  private updateDeleteApi = "https://api.knoldg.comm/api/admin/setting/department"; // Replace with the actual API URL
