...
export class DepartmentsService {
  private apiUrl = 'https://api.knoldg.com/api/common/setting/department/list'; // Replace with the actual API URL
  private createApi = "https://api.knoldg.com/api/admin/setting/department"; // Replace with the actual API URL
  private updateDeleteApi = "https://api.knoldg.com/api/admin/setting/department"; // Replace with the actual API URL
