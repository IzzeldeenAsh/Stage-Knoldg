...
export class DepartmentsService {
  private apiUrl = 'https://api.knoldg.co/api/common/setting/department/list'; // Replace with the actual API URL
  private createApi = "https://api.knoldg.co/api/admin/setting/department"; // Replace with the actual API URL
  private updateDeleteApi = "https://api.knoldg.co/api/admin/setting/department"; // Replace with the actual API URL
