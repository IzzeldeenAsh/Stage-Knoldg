...
export class ConsultingFieldTreeService {
  private apiUrl = 'https://api.foresigha.co/api/common/setting/consulting-field/tree/list'; 
  private apiList = 'https://api.foresigha.co/api/common/setting/consulting-field/list'
  ...
  getConsultingCodesTreeParent(lang:string): Observable<any[]> {
      ...
      this.setLoading(true);
      return this.http.get<any>('https://api.foresigha.co/api/common/setting/consulting-field/tree/parent', { headers }).pipe(
  ...
  createConsultingField(isicCode: any,lang:string): Observable<IsicCode> {
    ...
    this.setLoading(true);
    return this.http.post<IsicCode>('https://api.foresigha.co/api/admin/setting/consulting-field', isicCode, { headers }).pipe(
  ...
  updateConsultingField(id: number, isicCode: any, lang:string): Observable<IsicCode> {
    ...
    this.setLoading(true);
    return this.http.put<IsicCode>(`https://api.foresigha.co/api/admin/setting/consulting-field/${id}`, isicCode, { headers }).pipe(
      catchError(this.handleError),
      finalize(() => this.setLoading(false))
    );
  }
  ...
  deleteIsicCode(id: number): Observable<any> {
    ...
    this.setLoading(true);
    return this.http.delete<any>(`https://api.foresigha.co/api/admin/setting/consulting-field/${id}`, { headers }).pipe(
      catchError(this.handleError),
      finalize(() => this.setLoading(false))
    );
  }
