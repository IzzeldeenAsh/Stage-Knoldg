...
export class PasswordResetService {
  private forgetPasswordUrl = 'https://api.4sighta.com/api/common/user/password/forget';
  private resetPasswordUrl = 'https://api.4sighta.com/api/common/user/password/reset';
